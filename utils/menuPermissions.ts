...
export const routePermissionMap: Record<string, string[]> = {
  ...
  '/finance/operational': ['finance.operational-summary'],
  ...
  '/finance/admin-expenses': ['expenses-admin.list', 'expenses-admin.read'],
  '/finance/admin-expenses/create': ['expenses-admin.create'],
  '/finance/admin-expenses/:id/edit': ['expenses-admin.update', 'expenses-admin.read'],
