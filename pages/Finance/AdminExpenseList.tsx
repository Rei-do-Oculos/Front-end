...
export const AdminExpenseList: React.FC = () => {
  ...
  const showStoreFilter = storesList.length > 0;
  ...
  const canList = hasPermission('expenses-admin.list') || hasPermission('expenses-admin.read');
    ...
    <div className="space-y-8 animate-in fade-in duration-700">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
        <div className="flex items-center gap-4">
          <div>
            <h1 className="text-3xl font-black text-slate-950 tracking-tight">Despesas administrativas</h1>
            <p className="text-gray-500 font-medium mt-1">Uso exclusivo da gestão. Não aparece para vendedores nem entra no fluxo operacional de despesas da loja.</p>
          </div>
        </div>
        {hasPermission('expenses-admin.create') && (
          <Button onClick={() => navigate('/finance/admin-expenses/create')}>
            <Plus size={18} /> Nova despesa administrativa
          </Button>
        )}
      </div>
      ...
      <Card className="p-0 overflow-hidden">
                  ...
                  <tr key={exp.id} className="group hover:bg-slate-50/50 transition-colors">
                    <td className="px-6 py-4">
                      <div className="flex items-center gap-3">
                        ...
                        <p
                          ...
                          onClick={() => hasPermission('expenses-admin.read') && navigate(`/finance/admin-expenses/${exp.id}/edit`)}
                        >
                          {exp.name}
                        </p>
                      </div>
                    ...
                    <td className="px-6 py-4">
                      <div className="flex items-center justify-center gap-2">
                        {hasPermission('expenses-admin.update') && (
                          <button
                            title="Editar"
                            onClick={() => navigate(`/finance/admin-expenses/${exp.id}/edit`)}
                        ...
                        {hasPermission('expenses-admin.delete') && (
                          <button
                            title="Excluir"
        ...
        {pagination && (
          <Pagination
            ...
            itemName="despesas administrativas"
          />
        )}
      </Card>
