...
import { Edit, Plus, Trash2, Loader2, Building2, Phone, Mail, Clock } from 'lucide-react';
...
export const LaboratoryList: React.FC = () => {
  ...
  const handleConfirmDelete = async () => {
    ...
    setDeleting(true);
    try {
      await deleteLaboratory(String(laboratoryToDelete.id));
      ...
      >
        <div className="space-y-4">
          ...
          <p className="text-xs text-slate-500">
            Esta ação não pode ser desfeita. Todos os produtos vinculados a este laboratório também serão afetados.
          </p>
